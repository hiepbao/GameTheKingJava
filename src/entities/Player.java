...
public class Player extends Entity {
	...
	private int pointBarYStart = (int) (34 * Game.SCALE);
        ...
        private int levelBarXStart = (int) (Game.GAME_WIDTH - 150 * Game.SCALE);
	private int levelBarYStart = (int) (54 * Game.SCALE);
	...
	public void update() {
		...
		if (state == HIT) {
			if (aniIndex <= GetSpriteAmount(state) - 3)
				pushBack(pushBackDir, lvlData, 0.25f);
...
//		drawAttackBox(g, lvlOffset);
	...
	private void drawUI(Graphics g) {
		...
		g.fillRect(powerBarXStart + statusBarX, powerBarYStart + statusBarY, powerWidth, powerBarHeight);
                ...
                //level
                g.drawString("Level: "+levelNumber.getLevelNum(), levelBarXStart + statusBarX, levelBarYStart + statusBarY);
        }
	...
	public void loadAnimations() {
            System.out.println("aaaa"+choosePlayer.getIndexChoose());
            choosePlayer.getImgSpriteAtlas();
            img = choosePlayer.getImg();
            System.out.println("ccc"+choosePlayer.getIndexChoose());
//            
