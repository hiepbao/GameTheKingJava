...
public class Constants {
	...
	public static class EnemyConstants {
		...
		public static final int SHARK_WIDTH = (int) (150 * Game.SCALE);
		public static final int SHARK_HEIGHT = (int) (100 * Game.SCALE);
		public static final int SHARK_DRAWOFFSET_X = (int) (50 * Game.SCALE);
		public static final int SHARK_DRAWOFFSET_Y = (int) (75 * Game.SCALE);

		public static int GetSpriteAmount(int enemy_type, int enemy_state) {
			switch (enemy_state) {

			case IDLE: {
				if (enemy_type == CRABBY || enemy_type == SHARK)
					return 4;
